...
`;
    ...
    return (
        <header className={styles.jide_container}>
            Want to compile and run offline in a browser? Visit <a rel="noopener noreferrer" href={"https://wasm.jukalang.com"} target={"_blank"}>https://wasm.jukalang.com</a><br/><br/>
